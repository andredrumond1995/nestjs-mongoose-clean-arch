...
import { InputIsNotUniqueException } from '@shared/application/exceptions/input-is-not-unique.exception';
...
@Catch(InputIsNotUniqueException)
export class InputIsNotUniqueExceptionFilter implements ExceptionFilter {
  public constructor(
  ...
  public catch(exception: NotFoundException, host: ArgumentsHost): void {
    ...
    this.logger.error({
      ...
      context: 'InputIsNotUniqueExceptionFilter.catch',
      message,
      data: {
        stack,
      },
