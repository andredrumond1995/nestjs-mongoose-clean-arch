...
import { DocumentsNotFoundByIdException } from '@shared/application/exceptions/documents-not-found-by-id.exception';
...
@Catch(DocumentsNotFoundByIdException)
export class DocumentsNotFoundByIdExceptionFilter implements ExceptionFilter {
  public constructor(
